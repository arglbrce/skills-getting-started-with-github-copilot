...
activities = {
    ...
    "Drama Club": {
        "description": "Perform scenes, improvise, and prepare for school theater productions",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 25,
        "participants": ["isabella@mergington.edu", "oliver@mergington.edu"]
    },
    "Debate Team": {
        "description": "Build persuasive speaking and critical thinking skills through debate",
